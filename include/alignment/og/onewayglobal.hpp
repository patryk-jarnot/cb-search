...
#ifndef NSC_SEARCH_INCLUDE_ALIGNMENT_OG_ONEWAYGLOBAL_HPP_
#define NSC_SEARCH_INCLUDE_ALIGNMENT_OG_ONEWAYGLOBAL_HPP_
...
namespace nscsearch {
	class OneWayGlobal : public AlignBase {
	public:
...
#endif /* NSC_SEARCH_INCLUDE_ALIGNMENT_OG_ONEWAYGLOBAL_HPP_ */
