/*
 * ogaffinitymatrices.hpp
 *
 *  Created on: Dec 29, 2024
 *      Author: pjarnot
 */

#ifndef NSC_SEARCH_INCLUDE_ALIGNMENT_OG_OGGAPAFFINITYMATRICES_HPP_
#define NSC_SEARCH_INCLUDE_ALIGNMENT_OG_OGGAPAFFINITYMATRICES_HPP_
...
namespace nscsearch {
	class OgGapAffinityMatrices {
	public:
		enum class BestMove { NONE, MATCH, X, Y };

		OgGapAffinityMatrices();
...
#endif /* NSC_SEARCH_INCLUDE_ALIGNMENT_OG_OGGAPAFFINITYMATRICES_HPP_ */
